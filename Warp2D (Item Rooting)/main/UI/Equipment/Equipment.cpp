...
void CEquipment::DrawClient(ID2D1HwndRenderTarget * pd2dRenderTarget)
{
...
void CEquipment::DrawCaption(ID2D1HwndRenderTarget * pd2dRenderTarget)
{
...
void CEquipment::BuildObject(CScene * scene)
{
...
void CEquipment::Update(float fTimeElapsed)
{
}
